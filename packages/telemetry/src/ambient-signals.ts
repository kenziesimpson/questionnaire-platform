import { EVENT_LOOP_METRIC_NAMES, PG_OPERATION_DURATION } from "./instrument-allowlist.js";
...
export function isAmbientMetric(name: string): boolean {
  return POOL_METRIC_NAMES.includes(name) || EVENT_LOOP_METRIC_NAMES.includes(name);
}
